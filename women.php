...
<body>
    ...
    <div id="centre">
       ...
       <?php
        ...
        $request="SELECT * FROM product WHERE category='women' ";
        ...
        echo "<table rules='rows' style='width: 100%; text-align: center;'>";
            ...
            { 
               ...
               foreach ($row as $field => $value) {
                if ($field=="image") {
                    echo "<td><img style=' width:60%; height: -10%;' src='admin/images/".$row['image']."'></td>";
                }
            }
            echo "<td style='width:auto';><form action ='' method='post'>
                        ...
                        text-align: center;
                        width: auto;'><a href='productDetails.php?ID={$row['productId']}'
        ...
        else {echo "<br><h1 style='text-align: center; color : #83756e ;'>No product founds!</h1><br>";}
        ?>             
