...
if(!empty($_POST['searchh']))
{
    ...
    $query="SELECT * FROM personal_information where zip_code like '%$keyword%' or User_name like '%$keyword%' or city like '%$keyword%' or full_name like '%$keyword%' or mail_address like '%$keyword%'" ;
