...
<table border="1" align="center" frame="void" style="width: auto; text-align: center;" rules="rows">
...
if(mysqli_num_rows($result)>0) {
    while ($row=mysqli_fetch_assoc($result)) {
        ...
        <td><img style="padding-top: 10px; width:150px; height: 150px;" src="images/<?= $row['newimage']?> "></td>
